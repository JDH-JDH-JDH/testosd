...
/* ---- start customized ----*/
var FORCE_FALLBACK = !!(ua.match(/embedded in WebSite X5 \(WSX5\)$/)); 
var IS_NATIVELY_SUPPORTED = !FORCE_FALLBACK && (!IS_ANDROID_CHROME || ANDROID_CHROME_VERSION > 37) && defined(native("fullscreenElement")) && (!defined(fsEnabled) || fsEnabled === true);
/* ---- end customized ----*/
