(function ( $, x5engine ) {
	...
	s.siteId = 'BA9417EA4938A04FEAD0CF4474E00A76';
	...
	b.push(function () {
		x.stickyBar({
			enabledBreakpoints: ['71b14e2b2a5121661fb7ddae017bdbf6','84141698c461ca45194e4acad6f21ebb','72e5146e7d399bc2f8a12127e43469f1','5ecdcca63de80fd3d4fbb36295d22b7d']
		});
	});
	...
	b.push(function () {
		x5engine.captcha.instance = new x5engine.captcha.x5captcha({
			"offlineCodes": {
				"0": { letter: '5', path: 'captcha/imcpa_fv2.gif'},
				"1": { letter: '2', path: 'captcha/imcpa_g8u.gif'},
				"2": { letter: 'Y', path: 'captcha/imcpa_sze.gif'},
				"3": { letter: '7', path: 'captcha/imcpa_vdd.gif'},
				"4": { letter: 'J', path: 'captcha/imcpa_eya.gif'},
				"5": { letter: 'Y', path: 'captcha/imcpa_px7.gif'},
				"6": { letter: 'F', path: 'captcha/imcpa_mug.gif'},
				"7": { letter: 'T', path: 'captcha/imcpa_cy5.gif'},
				"8": { letter: 'Z', path: 'captcha/imcpa_lhr.gif'},
				"9": { letter: 'V', path: 'captcha/imcpa_3yn.gif'}
			}
		});
	}, false, 'first');
	...
	b.push(function() { x.cookielaw.showBanner({id: "cookie-law-message",offlineTimeStamp: 636694106236150000,texts: [
		{ basepath: "", text: "<div><span class=\"fs11lh1-5 ff1\">Ce site utilise des cookies pour vous garantir une meilleure expérience.</span></div>" },
		{ basepath: "../", text: "<div><span class=\"fs11lh1-5 ff1\">Ce site utilise des cookies pour vous garantir une meilleure expérience.</span></div>" }
	],
